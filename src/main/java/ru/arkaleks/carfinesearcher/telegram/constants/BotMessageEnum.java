...
public enum BotMessageEnum {
    ...
    REGISTRATION_NUMBER_MESSAGE("Регистрационный знак ТС принят. Введите и отправьте свидетельство о регистрации ТС в формате: 99АА999999"),
    CERTIFICATE_NUMBER_MESSAGE("Cвидетельство о регистрации ТС принято. Для продолжения нажмите \"Отправить запрос\""),
